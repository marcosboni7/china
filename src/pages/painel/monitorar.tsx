    ...
    return (
        <div>
            ...
            <div className='text-center mt-[-742px] '>
                <h1 className='text-white font-bold mt-[-353px] text-[50px] '>PEDIDOS</h1>

            </div>
            <div className="container font-bold mt-[-308px] ml-[118px] ">
                <div className='grid grid-cols-3 gap-3  space-x-4 m-[333px] '>
                    <div className="text-white">Rifa</div>
                    <div className="text-white">Quantidade comprada</div>
                    <button className="bg-green-600 w-[123px] text-white text-center rounded ">Encerrar Rifa</button>
                </div>
            </div>
        </div>
